...
## 개요
물류 작업의 생성, 수정, 삭제 및 상태 관리를 담당하는 핵심 애그리거트. 
입고, 출고, 내부 이동 작업을 통해 재고 이동을 관리하며, 실시간 정합성 검증과 상태 추적을 제공.
...
### 3. MQ 기반 비동기 재고 변경 처리

### 4. 실시간 대시보드
- 10분 단위 시간대별 작업 스케줄 제공
- 작업자별 실시간 진행 상황 추적
- 상태별 통계 실시간 업데이트
